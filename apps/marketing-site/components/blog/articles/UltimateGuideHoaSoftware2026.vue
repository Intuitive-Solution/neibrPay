<template>
  <div>
    ...
    <p>
      No fluff, no enterprise jargon, and no pretending your board is something
    ...
    <ul>
      ...
      <li>
        ...
        operating account isn't a personal checking account. Hand-keying
        transactions into Excel is now the most expensive thing your treasurer
        does.
      </li>
      <li>
    ...
    <p>
      In plain English, HOA software is a single web app that handles four
    ...
    <ol>
      ...
      <li>
        ...
        recording reimbursements, and reconciling against the bank.
      </li>
      <li>
        <strong>Records:</strong> storing CC&Rs, meeting minutes, budgets,
        reserve studies, insurance docs, and any file the board needs in one
        place.
      </li>
      <li>
        <strong>Communication:</strong> sending announcements, handling
        violation notices, processing architectural requests, and giving each
        homeowner a portal to see what they owe and what's happening.
      </li>
    </ol>
    ...
    <h3>2. Automated invoicing and reminders</h3>
    <p>
    ...
    <p>
      Every dollar leaving the operating account should be tied to a vendor and
      a category (landscaping, insurance, utilities, reserves). Bonus points if
      the system handles 1099 reporting and lets you upload receipts from your
      phone.
    </p>

    <h3>4. Homeowner portal</h3>
    <p>
    ...
    <p>
      CC&Rs, bylaws, financials, meeting minutes, and reserve studies in a
      single, searchable library. The minimum bar: it has to outlast whichever
      board member set it up.
    </p>

    <h3>6. Financial reporting</h3>
    <p>
      Income statements, balance sheets, accounts receivable aging, and budget
      vs. actual reports your accountant won't laugh at. If the tool can't
      export to your CPA's format, it isn't HOA software.
    </p>
    ...
    <ul>
      ...
      <li>
        <strong>Drafting letters and notices</strong> from templates and the
        owner's account history (violations, late payments, ARC approvals).
      </li>
      <li>
    ...
    <h2 id="choose">How to choose the right platform: a buyer's checklist</h2>
    ...
    <ul>
      ...
      <li>Does it support ACH, card, and at least one mobile-first method?</li>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>Buildium</td>
          <td>Property managers with HOA portfolios</td>
          <td>Mature platform, strong accounting</td>
          <td>Built for management companies, overkill for volunteers</td>
        </tr>
        <tr>
          <td>HOA Start / EasyHOA</td>
          <td>Very small HOAs and condos</td>
          <td>Cheap, simple</td>
          <td>Minimal AI, weaker reporting and audit trails</td>
        </tr>
        <tr>
          <td>Condo Control</td>
    ...
    <p>
      The switching cost is what keeps most boards stuck. It's smaller than you
      think. Here's the order that works:
    </p>

    <ol>
      <li>
        <strong>Export what you have.</strong> Owner roster (name, address,
        unit, email), 12 months of dues history, open balances, vendor list, and
        YTD income/expense.
      </li>
      <li>
    ...
    <ul>
      ...
      <li>Upload owner roster and last 12 months of dues activity.</li>
      <li>
        Configure the dues schedule (monthly/quarterly), late fees, and grace
        period.
      </li>
    </ul>
    ...
    <ul>
      ...
      <li>
        ...
        checks "for one or two owners," you're maintaining two payment systems.
        Set a sunset date.
      </li>
      <li>
        <strong>Treating reserves like a savings account.</strong> A reserve
        study and a forecasted reserve plan inside your software is the
        difference between a $200 special assessment and a $20,000 one.
      </li>
      <li>
      ...
      <li>
        ...
        see the portal, they don't trust it. Ten minutes of email and a
