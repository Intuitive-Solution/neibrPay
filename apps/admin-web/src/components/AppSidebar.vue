      ...
      >
        <ul class="space-y-1">
          ...
          <li>
            <router-link
              to="/budget"
              :class="getNavLinkClass('Budget')"
              :title="!(isExpanded || isMobileMenuOpen) ? 'Budget' : ''"
            >
              <svg
                :class="[
                  'w-5 h-5',
              ...
              <span v-if="isExpanded || isMobileMenuOpen">Budget</span>
            </router-link>
          </li>
...
const pageDescription = computed(() => {
  switch (route.name) {
    ...
    case 'Budget':
      return 'Track income and expense forecasts vs actuals';
    default:
      return 'Overview of your HOA community management';
  }
});
