...
class UpdateVendorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'state' => 'sometimes|string|size:2|in:AL,AK,AZ,AR,CA,CO,CT,DE,FL,GA,HI,ID,IL,IN,IA,KS,KY,LA,ME,MD,MA,MI,MN,MS,MO,MT,NE,NV,NH,NJ,NM,NY,NC,ND,OH,OK,OR,PA,RI,SC,SD,TN,TX,UT,VT,VA,WA,WV,WI,WY,DC',
            'zip_code' => 'sometimes|string|regex:/^\d{5}(-\d{4})?$/',
            'website' => 'nullable|url|max:255',
            'notes' => 'nullable|string',
            'contact_name' => 'sometimes|string|max:255',
            'contact_email' => 'sometimes|email|max:255',
            'contact_phone' => 'sometimes|string|regex:/^\(\d{3}\)\s\d{3}-\d{4}$/',
        ];
    }
